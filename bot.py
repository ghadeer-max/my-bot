...
def handle_message(message):
    ...
    if text == '🔥 فري فاير':
        ...
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(types.KeyboardButton('/start'))
        bot.send_message(message.chat.id, "✅ لقد اخترت حزمة:\n• 60 شدة روبوت (السعر: 127 ل.س)\n\n📝 يرجى إرسال الـ (ID) الخاص بك الآن في الشات كرسالة نصية لخصم المبلغ والشحن:", reply_markup=markup)
    elif text == '325 شدة روبوت':
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(types.KeyboardButton('/start'))
        bot.send_message(message.chat.id, "✅ لقد اخترت حزمة:\n• 325 شدة روبوت (السعر: 623 ل.س)\n\n📝 يرجى إرسال الـ (ID) الخاص بك الآن في الشات كرسالة نصية لخصم المبلغ والشحن:", reply_markup=markup)
    elif text == '660 شدة روبوت':
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(types.KeyboardButton('/start'))
        bot.send_message(message.chat.id, "✅ لقد اخترت حزمة:\n• 660 شدة روبوت (السعر: 1,229 ل.س)\n\n📝 يرجى إرسال الـ (ID) الخاص بك الآن في الشات كرسالة نصية لخصم المبلغ والشحن:", reply_markup=markup)
    elif text == '1800 شدة روبوت':
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(types.KeyboardButton('/start'))
        bot.send_message(message.chat.id, "✅ لقد اخترت حزمة:\n• 1800 شدة روبوت (السعر: 3,143 ل.س)\n\n📝 يرجى إرسال الـ (ID) الخاص بك الآن في الشات كرسالة نصية لخصم المبلغ والشحن:", reply_markup=markup)
    elif text == '3850 شدة روبوت':
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(types.KeyboardButton('/start'))
        bot.send_message(message.chat.id, "✅ لقد اخترت حزمة:\n• 3850 شدة روبوت (السعر: 6,190 ل.س)\n\n📝 يرجى إرسال الـ (ID) الخاص بك الآن في الشات كرسالة نصية لخصم المبلغ والشحن:", reply_markup=markup)
    elif text == '8100 شدة روبوت':
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(types.KeyboardButton('/start'))
        bot.send_message(message.chat.id, "✅ لقد اخترت حزمة:\n• 8100 شدة روبوت (السعر: 11,909 ل.س)\n\n📝 يرجى إرسال الـ (ID) الخاص بك الآن في الشات كرسالة نصية لخصم المبلغ والشحن:", reply_markup=markup)
        ...
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(types.KeyboardButton('/start'))
        bot.send_message(message.chat.id, "💳 <b>الشحن عبر شام كاش:</b>\n\nيرجى التحويل إلى الحساب الخاص بنا عبر تطبيق شام كاش، ثم إرسال صورة الإيصال أو رقم الحوالة هنا لتتم إضافة الرصيد لحسابك فوراً.", parse_mode='HTML', reply_markup=markup)
        ...
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(types.KeyboardButton('/start'))
        bot.send_message(message.chat.id, "✅ لقد استلمنا رسالتك أو الـ (ID) الخاص بك بنجاح وستتم معالجة الطلب.\nللعودة للقائمة الرئيسية اضغط على الزر أدناه:", reply_markup=markup)
